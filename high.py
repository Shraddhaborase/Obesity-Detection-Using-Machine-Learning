...
root.title("High Weight")

# FOR BACKGROUND IMAGE
image2 = Image.open('high.jpg')
...
# TITLE
text_label = tk.Label(root, text="HIGH OVER WEIGHT DETECTED..!", font=("times", 21, "bold"), fg="firebrick1", bg="white")
text_label.place(x=420, y=240, anchor=tk.CENTER)
